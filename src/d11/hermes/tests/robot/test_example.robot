...
#
#  $ bin/test -s d11.hermes -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src d11.hermes.testing.D11_HERMES_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/d11/hermes/tests/robot/test_example.robot
#
